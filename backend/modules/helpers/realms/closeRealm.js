...
async function closeRealm(realmID, db, guildID) {
    ...
    const response = await fetch(`https://pocket.realms.minecraft.net/worlds/${realmID}/close`, requestData)
    if (!response.ok) {
