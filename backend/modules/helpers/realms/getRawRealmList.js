...
async function getRawRealmList(guildID, db) {
    ...
    const response = await fetch(`https://pocket.realms.minecraft.net/worlds`, requestData);
    if (!response.ok) {
...
module.exports = getRawRealmList;
