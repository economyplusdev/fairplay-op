...
async function realmCodeCommand(guildID, locale, realms) {
    try {
        const response = await axios.post(
            `http://localhost:1112/api/discordbot/realmCodeCommand?guildID=${guildID}`,
            {
                locale: locale,
                realms: realms,
            },
...
module.exports = realmCodeCommand;
